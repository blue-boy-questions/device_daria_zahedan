...
# BOARD_{SYSTEM,VENDOR}_DLKM_PARTITION_SIZE are not build variables - the
# names AOSP reads have IMAGE in them. Without them nothing bounded the two
# dlkm images, and the values were stale anyway: vendor_dlkm.img in the
# shipping ROM is 14413824 B, 4096 B over the number that was here.
BOARD_SYSTEM_DLKMIMAGE_PARTITION_SIZE := 7196672
BOARD_VENDOR_DLKMIMAGE_PARTITION_SIZE := 14417920
...
BOARD_MTK_DYNAMIC_PARTITIONS_PARTITION_LIST := system system_ext product vendor vendor_dlkm system_dlkm
